...
main = Tk()
main.title("Smart and Secure Agriculture Using 5G and IoT with Machine  Learning")
...
plants = ['Apple__Apple_scab', 'Apple_Black_rot', 'Apple_Cedar_apple_rust', 'Apple_healthy', 'Corn(maize)___Cercospora_leaf_spot Gray_leaf_spot',
          'Corn_(maize)__Common_rust', 'Corn_(maize)__healthy', 'Corn(maize)__Northern_Leaf_Blight', 'Grape_Black_rot', 'Grape_Esca(Black_Measles)',
          'Grape__healthy', 'Grape_Leaf_blight(Isariopsis_Leaf_Spot)', 'Potato__Early_blight', 'Potato_healthy', 'Potato__Late_blight',
          'Tomato__Bacterial_spot', 'Tomato_Early_blight', 'Tomato_healthy', 'Tomato_Late_blight', 'Tomato_Leaf_Mold', 'Tomato__Septoria_leaf_spot',
...
def predict():
    ...
    cv2.putText(img, 'Crop Disease Recognize as : '+plants[predict], (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.7, (0, 255, 255), 2)
...
font = ('times', 15, 'bold')
title = Label(main, text='Smart and Secure Agriculture in desert areas Using 5G and IoT with Machine  Learning')
...
modelButton = Button(main, text="Build Crop Disease & Chemical Detection Model", command=cnnModel)
...
predictButton = Button(main, text="Upload Test Image & Predict Disease & Chemical", command=predict)
